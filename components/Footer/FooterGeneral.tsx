        ...
        <>
            <footer className="bg-gray-100 dark:bg-gray-900 py-6 mt-12">
                <div className="text-center px-4">
                    <h2 className="text-lg sm:text-xl font-bold mb-4 text-gray-900 dark:text-white">Check out my socials!</h2>
                    <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6 mb-4">
                        ...
                        <Link href="https://twitter.com/htoor01" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 text-blue-500 hover:text-blue-600 transition-colors">
                            <img src="/images/twitter.png" alt="Twitter" className="w-5 h-5" />
                            Twitter
                        </Link>
                    </div>
                    <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">Interested in reaching out directly? Send me a <Link href="/contact" className="text-blue-500 hover:text-blue-600 transition-colors">message</Link>!</p>
                </div>
            </footer>
